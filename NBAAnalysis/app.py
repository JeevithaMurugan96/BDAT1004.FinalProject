...
MONGO_URI = "mongodb+srv://1234:1234@cluster0.yrd96kn.mongodb.net/?retryWrites=true&w=majority"
...
def google_pie_chart():
    ...
    player_data = collection.find_one({'_id': ObjectId('64d437c3b90abaeaf0d93c7c')})  
    ...
    # Take the lowest 10 players

    lowest_10_players = player_stats[:10]

 

    data = []

    for player in lowest_10_players:
